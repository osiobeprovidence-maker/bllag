  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 fixed h-full z-20 hidden lg:block">
        ...
        <div className="absolute bottom-8 left-8 right-8 p-6 bg-accent/5 border border-accent/10">
      ...
      <main className="flex-1 lg:ml-64 p-8 lg:p-12">
        {/* Top Bar */}
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12 relative z-30">
          <div>
          ...
          <div className="flex items-center gap-6">
            ...
            <button 
              ...
              className="bg-primary text-white p-3 hover:bg-accent transition-colors shadow-lg"
            >
