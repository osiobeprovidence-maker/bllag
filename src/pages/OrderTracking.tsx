                ...
                >
                  <div className="bg-muted p-8 border border-gray-200">
                    <div className="flex justify-between items-center mb-6">
                      <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1">Status: <span className="text-accent">In Transit</span></p>
                        <p className="text-lg font-black uppercase tracking-tight">Est. Delivery: Oct 20</p>
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="relative space-y-10 pl-6 after:absolute after:left-[7px] after:top-[14px] after:bottom-[14px] after:w-px after:bg-gray-200">
                      <div className="relative">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest">Departed Sorting Facility</p>
                        <p className="text-[10px] text-muted-foreground uppercase tracking-widest mt-1">Lagos Main Hub — Oct 18, 2023 at 3:30 PM</p>
                      </div>
                      <div className="relative">
                      ...
                      <div className="relative">
                        ...
                        <p className="text-[10px] text-muted-foreground uppercase tracking-widest mt-1">Oct 16, 2023 at 9:15 PM</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
